...
execute if score title start_timer matches 1200 run title @a title [{"font":"space:default","translate":"space.60"},{"font":"mmsmp:title","text":"\uEff5","shadow_color":0b}]
execute if score title start_timer matches 1600 run title @a title [{"font":"space:default","translate":"space.60"},{"font":"mmsmp:title","text":"\uEff7","shadow_color":0b}]
